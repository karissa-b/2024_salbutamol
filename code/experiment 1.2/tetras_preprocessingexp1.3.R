...
file_list <- list.files(path = here("data/exp1.3/raw_data/zones"),
                        pattern = "*.csv",
                        full.names = TRUE,
                        recursive = TRUE)
...
subject2fish[11,]$fish <- c("81 82 83 84 85 86 1000 10001")
subject2fish[12,]$fish <- c("87 88 89 90 91 99 1002 10003")
...
write.csv(df, "data/exp1.3/processed_data/tidy_data.csv")
...
write.csv(df_a, "data/exp1.3/processed_data/time_in_zone.csv")
...
## STEP 7 - Final Output
write.csv(final_data, "data/exp1.3/processed_data/final_output.csv")
