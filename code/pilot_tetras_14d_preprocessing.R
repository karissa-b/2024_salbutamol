...
file_list <- list.files(path = here("data/pilot/14 days/raw_data/zones"),
                        pattern = "*.csv",
                        full.names = TRUE,
                        recursive = TRUE)
...
write.csv(df, "data/pilot/14 days/processed_data/tidy_data.csv")
...
write.csv(df_a, "data/pilot/14 days/processed_data/time_in_zone.csv")
...
## STEP 7 - Final Output
write.csv(final_data, "data/pilot/14 days/processed_data/final_output.csv")
